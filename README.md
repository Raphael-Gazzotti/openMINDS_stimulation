<a href="/img/openMINDS-stimulation_logo_light.png">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="/img/openMINDS-stimulation_logo_dark.png">
    <source media="(prefers-color-scheme: light)" srcset="/img/openMINDS-stimulation_logo_light.png">
    <img alt="openMINDS stimulation metadata model" src="/img/openMINDS-stimulation_logo_light.png" title="Logo created by U. Schlegel, L. Zehl, C. Hagen Blixhavn" align="right" height="70">
  </picture>
</a>
...
There you can also explore directly the :arrow_right: [**openMINDS_stimulation schema specifications**][docu-stimulation-url].
